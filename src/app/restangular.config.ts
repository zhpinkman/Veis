...
export function RestangularAuthFactory(restangular: Restangular, authService: AuthService) {
...
export const RESTANGULAR_NOT_AUTH = new InjectionToken<any>('RestangularNotAuth');
